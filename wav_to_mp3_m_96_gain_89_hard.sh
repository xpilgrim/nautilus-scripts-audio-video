...
# sudo chmod +x /usr/share/nautilus-scripts/wav_to_mp3_m_96_gain_89_hard.sh
# sudo ln -s /usr/share/nautilus-scripts/wav_to_mp3_m_96_gain_89_hard.sh ~/.gnome2/nautilus-scripts/wav_to_mp3_m_96_gain_89_hard
#
...
(
	...
	message=$(lame -b 96 -m m -o -S --noreplaygain "$file" "${file%%.*}.mp3" 2>&1 && echo "Success")
